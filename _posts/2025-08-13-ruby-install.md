...
toc_sticky: true
---
깃허브 페이지를 시작하면, 얼마지나지 않아서 조금 더 빨리 작업하기 위해 그리고 깃허브 페이지에서 사용하는 정적 사이트 생성기 Jekyll을 내 컴퓨터에 설치해서 사용 할 필요를 느끼게 됩니다. 이 때 먼저 필요한 프로그램이 Ruby입니다. 이 Ruby를 설치해 보도록 하겠습니다.
